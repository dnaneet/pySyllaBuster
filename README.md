...
- 🗓️ Extracts lecture units that are semantically similar to some keyword of interest.
- 🧠 Generates a network graph of keywords.

## Installation
Clone the repository and install dependencies:
```bash
git clone https://github.com/dnaneet/pySyllaBuster.git
cd pySyllaBuster
